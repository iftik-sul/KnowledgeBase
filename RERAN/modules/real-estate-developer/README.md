...
* [shared-platform-features.md](shared-platform-features.md) — **rebuilt 2026-08-16** from this module's actual 19 built screens, replacing an earlier draft that copied individual-user's generic Submit/Track/Respond/Resubmit framing without checking it against what's here. This module has no single canonical submission form — what's actually built is **12 features, all written**: one cross-cutting **Applications** tracker, five **domain workspaces** (Projects, Property Registrations, Escrow Management, Fund Release Request, Sales & Disclosures) that applications actually originate from, and six **General Platform** features (Dashboard, Documents, Company Profile, Reports, Notifications, Help & Support). **Sales & Disclosures resolved 2026-08-16** as a compliance-tracking layer parallel to Property Registrations, not a domain workspace tied to a numbered service. **Proposed — not sourced, needs client confirmation.**
...
* **Resolved 2026-08-16** — `sales-and-disclosures.md`'s relationship to the numbered service catalogue. It is not tied to any numbered service; it is a compliance-tracking layer parallel to Property Registrations. See [Feature #6](service-flows/feature-06-sales-and-disclosures.md) for the full resolution and the one question this raised in turn (whether every registered sale requires a disclosure filing here).
* **Unresolved:** Feature #5 (Fund Release Request)'s UI mismatch — whether Service #10 (Project Profit Withdrawal) genuinely fits a screen shaped for milestone/construction-draw requests. Flagged at source, not resolved.
* **New 2026-08-16, unresolved:** Feature #9 (Company Profile) is the only screen in the module's shared-features layer with no sourced Validation Summary section — every other form screen has one. Confirm whether that's a genuine gap or simply not applicable to a profile page.
