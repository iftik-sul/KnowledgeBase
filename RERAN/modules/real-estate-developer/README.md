...
* [shared-platform-features.md](shared-platform-features.md) — **rebuilt 2026-08-16** from this module's actual 19 built screens, replacing an earlier draft that copied individual-user's generic Submit/Track/Respond/Resubmit framing without checking it against what's here. This module has no single canonical submission form — what's actually built is **6 Application Lifecycle features, all written**: one cross-cutting **Applications** tracker plus five **domain workspaces** (Projects, Property Registrations, Escrow Management, Fund Release Request, Sales & Disclosures) that applications actually originate from. **Sales & Disclosures resolved 2026-08-16** as a compliance-tracking layer parallel to Property Registrations, not a domain workspace tied to a numbered service. Six general-platform screens remain named but not yet written. **Proposed — not sourced, needs client confirmation.**
...
* **New 2026-08-16, unresolved:** Feature #5 (Fund Release Request)'s UI mismatch — whether Service #10 (Project Profit Withdrawal) genuinely fits a screen shaped for milestone/construction-draw requests. Flagged at source, not resolved.
