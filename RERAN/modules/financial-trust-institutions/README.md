...
> Not yet written. 18 service flow documents to follow, one per service.
...
**14 items await client confirmation.** They are listed in the To Confirm section of each document:
...
* **The "bank's internal auditor" in the mortgage workflow is unmapped.** The step exists in the source; the role performing it is not named among the four.
