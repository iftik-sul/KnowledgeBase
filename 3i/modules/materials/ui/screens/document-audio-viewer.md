...
**Document layout, 2026-08-26:** the document fills the entire left region of the screen edge-to-edge — not a smaller card inset within a dark surround. The elaborate top status bar used on [Video Player](video-player.md) (course title, course-progress bar, edit/bookmark/fullscreen icons) is **not** carried over here — those are video-specific affordances (fullscreen in particular makes no sense for a panel that already fills its container). In its place, a minimal top bar with a **back button only**, top-left. The right-hand course-content sidebar is unchanged from [Video Player](video-player.md) — same component, same states.

**No Overview/Notes tabs on this screen** — a further simplification, 2026-08-26, on top of the layout change above. [Video Player](video-player.md) keeps its two-tab pattern; Document Viewer does not carry it. Below the document region, only the lesson title/breadcrumb and the Previous Lesson / Next Lesson buttons remain — no tab row, no note-taking area, no overview text. If timestamped notes or a lesson overview are wanted for documents later, that's a new decision, not a restoration of something accidentally dropped.
