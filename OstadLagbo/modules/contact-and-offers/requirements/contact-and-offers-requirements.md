...
Derived from MVP Scope Baseline v1.2 §4. Governs the offer lifecycle, the in-app chat, phone reveal, and their notifications. Shagred-profile visibility follows SGP-05; reporting and blocking are created in `ratings-and-trust`; report handling in `admin-review`; connection analytics in ADM-12.
