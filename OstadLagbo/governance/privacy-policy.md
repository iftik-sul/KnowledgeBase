...
**If you use the app (either role):** offers you send or receive, chat messages and voice notes, ratings and reviews, reports and blocks, favorites, and usage events (map sessions, searches, profile views) used for platform analytics.

**If you browse as a guest:** no account data. Your live location, if you permit it, positions the map on your device only — we never store it.

## 3. What we do NOT collect

We never store your live GPS position — for Shagreds and guests, positioning happens on your device only, and no coordinates of yours are ever saved. Only Ostads have a stored map location, and only because they deliberately placed a public pin. We collect no payment or banking information — the platform handles no money.

## 4. Why we collect it

To operate the service: creating and verifying accounts, showing Ostads on the map, enabling offers and chat, and notifications. To build trust: identity verification and admin review before an Ostad becomes visible. To keep people safe: handling reports, enforcing blocks and suspensions, and retaining limited identity data to investigate abuse. To improve the platform: aggregated analytics about how discovery and connections work. We do not sell your data, and we show no third-party advertising.
...
Identity documents and selfies are stored encrypted, accessible only for admin review, with every access logged in a tamper-proof record. Passwords are stored hashed, never in plain text. Voice notes and media are stored on secured infrastructure. If a data breach affecting you occurs, we will notify you and the relevant authority as the Personal Data Protection Act, 2026 requires (see our incident response process).

## 8. Your rights

Under the Personal Data Protection Act, 2026 you may: **access** the data we hold about you; **correct** it (profile fields are self-service; identity fields via re-verification); **erase** it (self-service deletion, honored per Section 6); and **withdraw consent** at any time — withdrawing consent for data essential to the service means deleting your account, which you can do in-app without asking anyone. To exercise any right you cannot reach in-app, contact us at the address in Section 11.
...
Ostad Lagbo is for adults — you must be 18 or older to hold an account, enforced at registration. Guardians find and arrange teachers on behalf of learners under 18; the account, the chat, and the arrangement belong to the adult.
