...
Ratings, replies, aggregation, review moderation, trust signals, and rating/block instrumentation (RNT-01…06, RNT-09, RNT-10); visibility pause (OSP-11); favorites and shareable deep links (MAP-07, MAP-08); **automated** deletion machinery — **legal-hold set/release tooling (ADM-18, CL-041 — required by incident Playbooks 1 and 3, which are operable from this gate)**, the 30-day recovery window and retention purges on both deletion paths, whose sweep honours the purgeable predicate (no legal hold, no open appeal — CL-041) (rest of REG-12, ADM-18 complete; the user-facing delete shipped in Slice 1, CL-034), replacing the interim manual purge; pending-deletion recovery routing (REG-02); phone change and password change (REG-06, REG-07).
